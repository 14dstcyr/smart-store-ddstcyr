...
from scripts.OLAP.data_scrubber import DataScrubber  # noqa: E402
...
class TestDataScrubber(unittest.TestCase):
    ...
    def test_format_column_strings_to_upper_and_trim(self):
        ...
        self.assertFalse(df_formatted['Name'].str.strip().str.isupper().all(), "Strings not formatted to uppercase correctly")
